...
export default class Worker extends EventEmitter {
  ...
  runMethod(method, importScripts) {
    ...
    const args = methodStr
      .substring(methodStr.indexOf('(') + 1, methodStr.indexOf(')'))
      .split(',');
    const body = methodStr.substring(
      methodStr.indexOf('{') + 1,
